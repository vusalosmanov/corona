    ...
    {isLoading && <Loader/>}
      <section className='w-full h-auto'>
        <div className='max-[1320px] w-full mx-auto flex justify-center gap-[40px] items-center h-[600px]'>
          ...
          <form className="w-full flex justify-center items-center flex-col max-w-[450px]" onSubmit={resetPassword}>
            ...
            <button type='submit' className="mt-[30px] bg-[#fc8410] text-[#fff] px-[20px] py-[15px] w-full max-w-[240px] rounded-[5px] flex flex-row justify-center items-center text-center text-[18px] font-bold hover:bg-[#106853] ">Reset password</button>
